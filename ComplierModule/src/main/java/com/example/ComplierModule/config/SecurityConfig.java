...
import com.example.ComplierModule.services.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests(authorize -> authorize
                        ...
                        .requestMatchers(new AntPathRequestMatcher("/noSave/**")).permitAll() // Allow POST requests to /user without authentication
